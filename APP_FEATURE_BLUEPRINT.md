...
> 快照日期：2026-09-04
>
> 仓库基线：`8c51ee82e292866e4a8ff75ee36d0b744f1b2a41`，当前工程为 Build 45；Build 45 代码已接入，真实设备和完整发布验证仍待补
>
> 发布版本：`MARKETING_VERSION = 2.0.8`，主 App / Widget / Watch / Tests `CURRENT_PROJECT_VERSION = 45`
>
