...
extension OBDCommand.Mode1 {
    public var properties: CommandProperties {
        ...
        case .catalystTempB1S1: return CommandProperties("013C", "Catalyst Temperature: Bank 1 - Sensor 1", 3, .uas(0x16), true)
        case .catalystTempB2S1: return CommandProperties("013D", "Catalyst Temperature: Bank 2 - Sensor 1", 3, .uas(0x16), true)
        case .catalystTempB1S2: return CommandProperties("013E", "Catalyst Temperature: Bank 1 - Sensor 2", 3, .uas(0x16), true)
        case .catalystTempB2S2: return CommandProperties("013F", "Catalyst Temperature: Bank 1 - Sensor 2", 3, .uas(0x16), true)
        ...
        case .engineOilTemp: return CommandProperties("015C", "Engine oil temperature", 2, .temp, true, maxValue: 215, minValue: -40)
